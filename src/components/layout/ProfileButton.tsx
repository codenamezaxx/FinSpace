...
import { LogOut, Settings, Cloud, CloudOff, Sun, Moon } from "lucide-react";
    ...
    return (
      <div ref={ref} className="relative">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white/10 bg-surface/65 text-sm font-bold text-text-primary backdrop-blur-xl transition-all duration-200 hover:shadow-[0_0_24px_#8B5CF666]"
          aria-label="Menu"
        >
        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 top-10 z-50 w-56 animate-fade-scale rounded-2xl border border-white/10 bg-surface/95 p-3 shadow-2xl backdrop-blur-2xl">
              <button
                onClick={() => { setOpen(false); login(); }}
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-text-primary transition-colors hover:bg-surface"
              >
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-text-secondary transition-colors hover:bg-surface"
              >
